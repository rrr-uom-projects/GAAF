#!/bin/bash
python3 -m GAAF.inference   --model_dir "/home/ed/GAAF/models/headHunter2/fold1/" \
                            --use_attention "True" \
                            --in_image_dir "/mnt/driger/hn_data/Aza_HnN/CTs" \
                            --out_image_dir "/mnt/driger/hn_data/Aza_HnN/test/CTs" \
                            --out_CoMs_dir "None"\
                            --in_mask_dir "/mnt/driger/hn_data/Aza_HnN/Structures" \
                            --out_mask_dir "/mnt/driger/hn_data/Aza_HnN/test/Structures" \
